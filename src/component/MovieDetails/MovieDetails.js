...
<div class="movie-card">
  ...
  <div class="container">
    ...
    <a href="#"><img src={movieFound.posterUrl} alt="cover" class="cover" /></a>
        
      <div class="hero" style={{backgroundImage:`url(${ movieFound.backImg})`, backgroundSize: 'cover',  backgroundRepeat: 'no-repeat'}}>
            
         <div class="details">

           <span class="title1">{movieFound.title}<span className="spn">{ movieFound.duration}</span></span>

          <div class="heading heading--stroke-shadow"> {movieFound.director}</div>    
        


          <div  class='num' style={{marginTop:'20px',marginBottom:'20px'}}>{ movieFound.year}</div>
              <div style={{marginTop:'10px'}}>
                 <Rate rate={movieFound.rate}/>
              </div>
      ...
      <div class="description">
       ...
       <div class="column1">
          <span class="tag">{movieFound.type}</span>
       </div> 
       <div class="container-fluid">
         <div class="row">
          ...
          {/* --------------------------- bouton trailer ------------------------- */}
          <div style={{marginTop:'50px' ,height:'50px', width:'200px'}}>
            <Link to={`/trailer/${movieFound.title}`} style={{textDecoration:'none'}}> 
